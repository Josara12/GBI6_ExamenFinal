...
library("sjPlot")
library("sjmisc")
#Lista1 <- df_long %>% group_by(dataset,Gen)
#Lista2 <- descr(x=Lista1, out= "viewer", #file="C:/Users/User/Desktop/Bioinformática1/GBI6_ExamenFinal/GBI6_ExamenFinal./Results/mRNA#_expr_summary.doc")
...
```{r}
tcga_boxplots1 <- df_long %>% filter(dataset, wind >= GATA3, Gen %in% c(GATA3))
tcga_boxplots <- 
